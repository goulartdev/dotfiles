# Generated by Powerlevel10k configuration wizard on 2023-08-29 at 21:36 -03.
...
() {
  ...
  # Unset all configuration options. This allows you to apply configuration changes withoutw
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=376
  ...
  ###########[ perlbrew: perl version from perlbrew (https://github.com/gugod/App-perlbrew) ]############
  # Perlbrew color.
  typeset -g POWERLEVEL9K_PERLBREW_FOREGROUND=5
